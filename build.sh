...
function write_e2e_env(){
  ...
  secret_vars=(
    ...
    MYSQL_IAM_USER_JAVA=MYSQL_USER_IAM_JAVA
    POSTGRES_CONNECTION_NAME=POSTGRES_CONNECTION_NAME
    POSTGRES_USER=POSTGRES_USER
    POSTGRES_IAM_USER=POSTGRES_USER_IAM_JAVA
    ...
    POSTGRES_CUSTOMER_CAS_PASS_INVALID_DOMAIN_NAME=POSTGRES_CUSTOMER_CAS_PASS_INVALID_DOMAIN_NAME
