...
public class JdbcPostgresIamAuthIntegrationTestsWithCredsFile {
  ...
  public void setUpPool() throws SQLException {
    ...
    connProps.setProperty("credsJsonFileLoc", CREDS_JSON_FILE_LOC);
    System.setProperty("cloudSql.socketFactory.credentialFactory","com.google.cloud.sql.core.CredsJsonFileCredentialFactory");
