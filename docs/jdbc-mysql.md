...
| -------------------------- | ---------------------------------------- |
| mysql-connector-java:8.x   | mysql-socket-factory-connector-j-8:1.13.0 |
| mysql-connector-java:5.1.x | mysql-socket-factory:1.13.0            |
...
```gradle
compile 'com.google.cloud.sql:mysql-socket-factory-connector-j-8:1.13.0'
```
