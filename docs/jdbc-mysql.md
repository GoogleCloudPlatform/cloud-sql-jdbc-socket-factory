...
| -------------------------- | ---------------------------------------- |
| mysql-connector-java:8.x   | mysql-socket-factory-connector-j-8:1.4.2-dev |
| mysql-connector-java:5.1.x | mysql-socket-factory:1.4.2-dev             |
...
```gradle
compile 'com.google.cloud.sql:mysql-socket-factory-connector-j-8:1.4.2-dev'
```
