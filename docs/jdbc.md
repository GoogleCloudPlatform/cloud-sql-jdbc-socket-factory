...
```gradle
compile 'com.google.cloud.sql:mysql-socket-factory-connector-j-8:1.28.6'
```
...
```gradle
compile 'com.google.cloud.sql:mariadb-socket-factory:1.28.6'
```
...
```gradle
compile 'com.google.cloud.sql:postgres-socket-factory:1.28.6'
```
...
```gradle
compile 'com.google.cloud.sql:cloud-sql-connector-jdbc-sqlserver:1.28.6'
```
