...
```gradle
compile 'com.google.cloud.sql:cloud-sql-connector-r2dbc-mysql:1.15.2'
```
...
```gradle
compile 'com.google.cloud.sql:cloud-sql-connector-r2dbc-postgres:1.15.2'
```
...
```gradle
compile 'com.google.cloud.sql:cloud-sql-connector-r2dbc-sqlserver:1.15.2'
```
