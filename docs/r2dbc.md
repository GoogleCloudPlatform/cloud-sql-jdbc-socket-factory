...
```gradle
compile 'com.google.cloud.sql:cloud-sql-connector-r2dbc-mysql:1.24.0'
```
...
```gradle
compile 'com.google.cloud:cloud-sql-connector-r2dbc-mariadb:1.24.0'
```
...
```gradle
compile 'com.google.cloud.sql:cloud-sql-connector-r2dbc-postgres:1.24.0'
```
...
```gradle
compile 'com.google.cloud.sql:cloud-sql-connector-r2dbc-sqlserver:1.24.0'
```
