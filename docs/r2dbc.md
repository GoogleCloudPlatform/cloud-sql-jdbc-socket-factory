...
```gradle
compile 'com.google.cloud.sql:cloud-sql-connector-r2dbc-mysql:1.17.2'
```
...
```gradle
compile 'com.google.cloud:cloud-sql-connector-r2dbc-mariadb:1.17.2'
```
...
```gradle
compile 'com.google.cloud.sql:cloud-sql-connector-r2dbc-postgres:1.17.2'
```
...
```gradle
compile 'com.google.cloud.sql:cloud-sql-connector-r2dbc-sqlserver:1.17.2'
```
