...
import static com.google.cloud.sql.core.GcpConnectionFactoryProvider.UNIX_SOCKET;
...
public class R2dbcMysqlUnixSocketIntegrationTests {
  ...
  private static final String UNIX_SOCKET_PATH = System.getenv("MYSQL_UNIX_SOCKET_PATH");
  ...
  public void setUpPool() {
    ...
    ConnectionFactoryOptions options = ConnectionFactoryOptions.builder()
        ...
        .option(UNIX_SOCKET, UNIX_SOCKET_PATH)
        .build();
